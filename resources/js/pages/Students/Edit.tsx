...
export default function Create() {
    ...
    const { data, setData, post, processing, errors, reset } = useForm({
        ...
        name: registrationAgreement.name ?? '',
        examed_year: registrationAgreement.examed_year ?? '',
        examed_month: registrationAgreement.examed_month ?? '',
        examed_name: registrationAgreement.examed_name ?? '',
        examed_roll_no: registrationAgreement.examed_roll_no ?? '',
        examed_status: registrationAgreement.examed_status ?? '',
        class: registrationAgreement.class ?? '',
        fee: registrationAgreement.fee ?? '',
        guardian: registrationAgreement.guardian ?? '',
        g_nrc_state: registrationAgreement.nrc_state ?? '',
        g_nrc_township: registrationAgreement.nrc_township ?? '',
        g_nrc_type: registrationAgreement.nrc_type ?? '',
        g_nrc_number: registrationAgreement.nrc_number ?? '',
        agreed: registrationAgreement.agreed ? true : false,
                ...
                <section>
                    <Table>
                        ...
                        <TableBody>
                            ...
                            {student.exams_taken.map((exam, index) => (
                                <TableRow key={index}>
                                    <TableCell>
                                        <Input
