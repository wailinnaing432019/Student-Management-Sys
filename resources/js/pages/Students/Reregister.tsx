...
export default function Create() {
    ...
    const { academic_years, majors, studentEnrollment } = usePage().props
    ...
    const examsTaken = student.exams_taken

    const { data, setData, post, processing, errors, reset } = useForm({
        // Student info
        name_myan: student.name_myan ?? 'no',
        name_eng: student.name_eng ?? '',
        academic_year_id: academicYear.id ?? '',
        semester_id: studentEnrollment.semester_id ?? null,
        major_id: studentEnrollment.major_id ?? '',
        ...
        dob: student.dob ?? '',
        gender: registrationAgreement?.gender ?? '',
        ...
        // mother table info
        mother_name_myan: mother.name_myan ?? '',
        mother_name_eng: mother.name_eng ?? '',
        mother_ethnicity: mother.ethnicity ?? '',
        mother_religion: mother.religion ?? '',
        mother_hometown: mother.hometown ?? '',
        mother_township_state_region: mother.township_state_region ?? '',
        mother_nrc_state: mother.nrc_state ?? '',
        mother_nrc_township: mother.nrc_township ?? '',
        mother_nrc_type: mother.nrc_type ?? '',
        mother_nrc_number: mother.nrc_number ?? '',
        mother_job: mother.job ?? '',
        mother_job_position_address: mother.job_position_address ?? '',
        mother_local_foreign: mother.local_foreign ?? '',
        ...
        father_name_myan: father.name_myan ?? '',
        father_name_eng: father.name_eng ?? '',
        father_ethnicity: father.ethnicity ?? '',
        father_religion: father.religion ?? '',
        father_hometown: father.hometown ?? '',
        father_township_state_region: father.township_state_region ?? '',
        father_nrc_state: father.nrc_state ?? '',
        father_nrc_township: father.nrc_township ?? '',
        father_nrc_type: father.nrc_type ?? '',
        father_nrc_number: father.nrc_number ?? '',
        father_job: father.job ?? '',
        father_job_position_address: father.job_position_address ?? '',
        father_local_foreign: father.local_foreign ?? '',
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        post(route('enroll-students.reregister', student.id));
    };

    // useEffect(() => {
    //     if (examsTaken?.length) {
    //         const transformed = examsTaken.map(exam => ({
    //             exam_name: exam.exam_name || '',
    //             exam_major: exam.major || '',
    //             exam_roll_no: exam.roll_no || '',
    //             exam_year: exam.year || '',
    //             exam_pass_fail: exam.pass_fail || '',
    //             isFromDB: true,
    //         }));

    //         setData('exam_records', transformed);
    //     }
    // }, [examsTaken]);
    const addExamRow = () => {
                                                                    ...
                                                                    [...filteredSemesters]
                                                                        ...
                                                                        .map((s: any) => (
                                                                            <SelectItem key={s.id} value={String(s.id)}>
                                                                                {getSemesterText(s.semester_number)}
                                                                            </SelectItem>
                                                                        ))
                                                                ) : (
                        ...
                        <Card className="p-6 space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div>
                                    ...
                                    <Input disabled id="name_myan" value={data.name_myan} onChange={(e) => setData('name_myan', e.target.value)} />
                                    <InputError message={errors.name_myan} />
                                </div>
                                <div>
                                    <Label>အဖအမည် (မြန်မာ)</Label>
                                    <Input disabled id="father_name_myan" value={data.father_name_myan} onChange={(e) => setData('father_name_myan', e.target.value)} />
                                    <InputError message={errors.father_name_myan} />
                                </div>
                                <div>
                                    <Label>အမိအမည် (မြန်မာ)</Label>
                                    <Input disabled id="mother_name_myan" value={data.mother_name_myan} onChange={(e) => setData('mother_name_myan', e.target.value)} />
                                    <InputError message={errors.mother_name_myan} />
                                </div>
                                <div>
                                    <Label>အမည် (အင်္ဂလိပ်)</Label>
                                    <Input disabled id="name_eng" value={data.name_eng} onChange={(e) => setData('name_eng', e.target.value)} />
                                ...
                                <div>
                                    ...
                                    <Input disabled id="father_name_eng" value={data.father_name_eng} onChange={(e) => setData('father_name_eng', e.target.value)} />
                                ...
                                <div>
                                    ...
                                    <Input disabled id="mother_name_eng" value={data.mother_name_eng} onChange={(e) => setData('mother_name_eng', e.target.value)} />
                                ...
                                <div>
                                    ...
                                    <Input disabled id="ethnicity" value={data.ethnicity} onChange={(e) => setData('ethnicity', e.target.value)} />
                                    <InputError message={errors.ethnicity} />
                                </div>
                                <div>
